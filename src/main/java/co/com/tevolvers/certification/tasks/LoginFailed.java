...
import static co.com.tevolvers.certification.utils.Credentials.*;
...
public class LoginFailed implements Task {
    ...
    public <T extends Actor> void performAs(T actor) {
        actor.attemptsTo(
                ...
                Enter.theValue(WRONG_PASSWORD).into(PASSWORD_FIELD),
                Click.on(LOGIN_BTN)
        );
    }

    public static LoginFailed login () {
        return instrumented(LoginFailed.class);
    }
}
